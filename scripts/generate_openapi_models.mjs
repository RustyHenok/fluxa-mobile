...
const schemaNameMap = new Map([
  ...
  ['ExportRequest', 'FluxaExportRequest'],
  ['JobResponse', 'FluxaJob'],
  ['JobResultResponse', 'FluxaJobResult'],
  ['LoginRequest', 'FluxaLoginRequest'],
  ['LogoutRequest', 'FluxaLogoutRequest'],
  ['MeResponse', 'FluxaMe'],
  ['ProjectPatchPayload', 'FluxaProjectPatchPayload'],
  ['ProjectPayload', 'FluxaProjectPayload'],
  ['ProjectResponse', 'FluxaProject'],
  ['ProjectSummary', 'FluxaProjectSummary'],
  ['RefreshRequest', 'FluxaRefreshRequest'],
  ['RegisterRequest', 'FluxaRegisterRequest'],
  ['SwitchTenantRequest', 'FluxaSwitchTenantRequest'],
  ['TaskAuditListResponse', 'FluxaTaskAuditPage'],
  ['TaskAuditResponse', 'FluxaTaskAuditEntry'],
  ['TaskFilters', 'FluxaTaskFilters'],
  ['TaskPatchPayload', 'FluxaTaskPatchPayload'],
  ['TaskPayload', 'FluxaTaskPayload'],
